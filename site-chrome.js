...
(function () {
  ...
  var CSS =
    ...
    + ".fsx-hero .h-section{font-family:'Cormorant Garamond',serif;font-style:italic;font-weight:400;font-size:clamp(34px,4.4vw,56px);line-height:1.04;letter-spacing:-.008em;margin-bottom:18px;color:#EFE7D8;text-wrap:balance;}"
    + ".fsx-hero .h-section em{font-style:italic;color:#C8531F;}"
